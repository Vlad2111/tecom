...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.28',
  'unifunc' => 'content_580771cb433da0_20551454',
  'file_dependency' => 
  array (
...
function content_580771cb433da0_20551454 ($_smarty_tpl) {
?>
...
">
						...
						<li class="<?php echo $_smarty_tpl->tpl_vars['status5']->value;?>
">
							<a 
								href="/index.php
 ...
 "
			...
			<div class="modal fade" id="Report" tabindex="-1" role="dialog" aria-labelledby="ReportLabel" >
				<div class="modal-dialog" role="document">
					<div class="modal-content" style="z-index:1000;">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" onClick="diactivedia()" aria-label="Close" diactivedia><span aria-hidden="true">&times;</span></button>
							<h4 class="modal-title" id="ReportLabel">Отчет за интервал</h4>
						</div>
						<form action="/index.php" method="get" onsubmit="diactiverep()">			
							<div class="modal-body">
								<div class="form-group">
...
>
			<?php echo '<script'; ?>
>
				function diactivedia() {
					document.getElementById('buttonModalSrep').disabled = 0;
					document.getElementById('buttonModalFrep').disabled = 0;
				}
			<?php echo '</script'; ?>
>
			<?php echo '<script'; ?>
>
				function diactiverep() {
					document.getElementById('buttonModalSrep').disabled = 1;
					document.getElementById('buttonModalFrep').disabled = 1;
				}
			<?php echo '</script'; ?>
>
			<?php echo '<script'; ?>
