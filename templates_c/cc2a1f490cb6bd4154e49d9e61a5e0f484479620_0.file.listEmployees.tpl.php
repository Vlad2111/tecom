...
function content_580786a7823d64_27813913 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
>
				...
				function checkedPercentsFunction(obj) {
					if(obj.value=="all"){
						$('#employeeList').DataTable().column(3).search('').draw();
					}
					if(obj.value=="notAll"){
						$('#employeeList').DataTable().column(3).search('.').draw();
					}
