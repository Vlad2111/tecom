<?php
/* Smarty version 3.1.28, created on 2016-10-10 15:04:15
  from "/var/www/hr-timetrack-dev/3pty/Smarty/demo/templates/department.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_57fb83bf5b7824_60359089',
  'file_dependency' => 
  array (
...
function content_57fb83bf5b7824_60359089 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
$_smarty_tpl->tpl_vars['numrow'] = new Smarty_Variable(0, null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'numrow', 0);?>
											<?php
...
?>
												<tr id="row<?php echo $_smarty_tpl->tpl_vars['numrow']->value;?>
"><?php $_smarty_tpl->tpl_vars['numrow'] = new Smarty_Variable($_smarty_tpl->tpl_vars['numrow']->value+1, null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'numrow', 0);?>
...
?>
											...
											<label style="font-weight:lighter;">
												<input 
													...
													checked 
													id="checkedPercents1" 
													name="checkedPercents" 
													onclick="checkedPercentsFunction(this);"/>
												Полный список
											</label>
											&emsp;&emsp;
											<label style="font-weight:lighter;">
												<input 
													...
													name="checkedPercents" 
													onclick="checkedPercentsFunction(this);"/>
												Только сотрудники с не распределенным временем
											</label>
										</table>
										<?php if ($_smarty_tpl->tpl_vars['status']->value == FALSE) {?>
										<a 
...
">
			...
			<?php echo '<script'; ?>
>
				function checkedPercentsFunction(obj) {
					numrow=<?php echo $_smarty_tpl->tpl_vars['numrow']->value;?>
;
					if(obj.value=="all"){
...
?>
								<?php if ($_smarty_tpl->tpl_vars['foo']->value['summ'] == 100) {?>
									document.getElementById('row<?php echo $_smarty_tpl->tpl_vars['numrow']->value;?>
').style.display = "none";
								<?php }?>
								<?php if ($_smarty_tpl->tpl_vars['foo']->value['summ'] != 100) {?>
									document.getElementById('row<?php echo $_smarty_tpl->tpl_vars['numrow']->value;?>
').style.display = "table-row";
								<?php }
$_smarty_tpl->tpl_vars['numrow'] = new Smarty_Variable($_smarty_tpl->tpl_vars['numrow']->value+1, null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'numrow', 0);?>
							<?php
