<?php
/* Smarty version 3.1.28, created on 2016-10-11 13:20:47
  from "/var/www/hr-timetrack-dev/3pty/Smarty/demo/templates/department.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_57fcbcffa7c8b4_31881529',
  'file_dependency' => 
  array (
...
function content_57fcbcffa7c8b4_31881529 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
%</td>
													<td><?php echo $_smarty_tpl->tpl_vars['foo']->value['summ']/100;?>
%</td>
													<td>
														<?php if ($_smarty_tpl->tpl_vars['status']->value == FALSE) {?>
														<a 
...
>
				$(function () {
					var table = $('#employeeDep').DataTable({
						"paging": true,
						"lengthChange": true,
						"searching": true,
						"ordering": true,
				...
				function checkedPercentsFunction(obj) {
					if(obj.value=="all"){
						$('#employeeDep').DataTable().column(3).search('').draw();
					}
					if(obj.value=="notAll"){
						$('#employeeDep').DataTable().column(3).search('.').draw();
					}
