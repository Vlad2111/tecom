							...
							<form action="/index.php" method="get">
								<div class="modal-body">
									<div class="modal-form-group">
										...
										<input type="text" class="form-control" id="nameEmployee" name="employeeName" value="{$employeeName}" disabled>
									</div>
									<div class="form-group">
										<label>Логин:</label>
										<input name="newLogin" type="text" class="form-control" id="loginEmployee" value="{$employeeLogin}" >
									</div>
									<div class="form-group">
										<label>Отдел:</label>
