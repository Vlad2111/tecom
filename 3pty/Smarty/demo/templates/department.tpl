					...
					<div align="center">
						<div class="col-lg-100 col-xs-100">
							<div class="small-box bg-purple">
								...
								<a class="btn btn-app" href="/index.php?route=EditAndCreate&content=editDepartment&departmentId={$departmentId}&departmentName={$departmentName}&Month={$selectedMonthForGet}&Year={$selectedYearForGet}">
									<i class="fa fa-edit"></i> Edit
								</a>
								<a class="btn btn-app" href="/index.php?route=list&content=Department&action=remove&departmentId={$departmentId}&Month={$selectedMonthForGet}&Year={$selectedYearForGet}">
						...
						<ol class="breadcrumb">
							...
							<li><a href="/index.php?route=list&content=Department&Month={$selectedMonthForGet}&Year={$selectedYearForGet}">List of Department`s</a></li>
