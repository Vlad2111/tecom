					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
      							<b><h3 class="box-title">Список Проектов</h3></b>	
      								<button data-toggle="modal" data-target="#myModal" class="btn btn-md" title="Выбрать Дату"><i class="glyphicon glyphicon-calendar"></i></button>
      								<a type="button" data-toggle="modal" data-target="#myModal" class="btn btn-md" title="Выбрать Дату"><i class="glyphicon glyphicon-calendar"></i></a>
 							</div>
							<div class="box-body">
								<table id="project" class="table table-bordered table-striped">
										<thead>
											<tr>
												<th style="width:10px; font-size:15px">№</th>
										...
										{foreach from=$array item=foo}
											...
											<tr>
												...
												<td><a id="refreshBtn" type="button" class="btn btn-md" data-toggle="modal" data-target="#myModal" title="Редактировать Данные Проекта"><i class="fa fa-pencil"></i></a></td>
											</tr>
										{/foreach}
										</tbody>
										<tfoot>
								...
								<a id="refreshBtn" type="button" data-toggle="modal" data-target="#myModal" class="btn btn-md" title="Добавить Проект"><i class="fa fa-pencil"></i></a>
