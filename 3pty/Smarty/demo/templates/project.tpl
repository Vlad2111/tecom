					...
					<div align="center">
						<div class="col-lg-100 col-xs-100">
							<div class="small-box bg-red">
								...
								<a class="btn btn-app" href="/index.php?route=EditAndCreate&content=createPercent&projectId={$projectId}&projectName={$projectName}&Month={$selectedMonthForGet}&Year={$selectedYearForGet}">
									<i class="fa fa-pencil"></i>New Percent
								</a>
								<a class="btn btn-app" href="/index.php?route=EditAndCreate&content=editProject&projectId={$projectId}&projectName={$projectName}&Month={$selectedMonthForGet}&Year={$selectedYearForGet}">
									<i class="fa fa-edit"></i>Edit Project
								</a>
								<a class="btn btn-app" href="/index.php?route=list&content=Project&action=remove&projectId={$projectId}&Month={$selectedMonthForGet}&Year={$selectedYearForGet}">
						...
						<ol class="breadcrumb">
							...
							<li><a href="/index.php?route=list&content=Project&Month={$selectedMonthForGet}&Year={$selectedYearForGet}">List of Project</a></li>
									...
									<table id="project" class="table table-bordered table-striped">
										...
										{foreach from=$array item=foo}
											...
											<tr>
												...
												<td>{$foo.time}%</td>
												<td>
													<a href="/index.php?route=EditAndCreate&content=editPercent&projectId={$projectId}&projectName={$projectName}&employeeId={$foo.employee_id}&employeeName={$foo.user_id}&lastPercent={$foo.time}&Month={$selectedMonthForGet}&Year={$selectedYearForGet}" target="_blank">
														<button type="button" style="width:150px" class="btn bg-orange margin btn-xs"><i class="fa fa-edit"></i> Edit Percent</button>
													</a>
													<a href="/index.php?route=project&action=remove&projectId={$projectId}&projectName={$projectName}&employeeId={$foo.employee_id}&Month={$selectedMonthForGet}&Year={$selectedYearForGet}" target="_blank">
