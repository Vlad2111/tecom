<?php
/* Smarty version 3.1.28, created on 2016-07-21 15:39:22
  from "C:\Users\ershov.v\workspace\tecom\3pty\Smarty\libs\debug.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_5790c27a4ce3a4_54680507',
  'file_dependency' => 
  array (
    'f027c4b1d3b7ac49f55a5cdecea010adb2d0811b' => 
    array (
      0 => 'C:\\Users\\ershov.v\\workspace\\tecom\\3pty\\Smarty\\libs\\debug.tpl',
      1 => 1468319073,
      2 => 'file',
    ),
  ),
...
function content_5790c27a4ce3a4_54680507 ($_smarty_tpl) {
if (!is_callable('smarty_modifier_debug_print_var')) require_once 'C:\\Users\\ershov.v\\workspace\\tecom\\3pty\\Smarty\\libs\\plugins\\modifier.debug_print_var.php';
$_smarty_tpl->_cache['capture_stack'][] = array('_smarty_debug', 'debug_output', null); ob_start(); ?>
    ...
    <h1>Smarty <?php echo htmlspecialchars(Smarty::SMARTY_VERSION, ENT_QUOTES, 'ISO-8859-1');?>
 Debug Console
...
echo smarty_modifier_debug_print_var($_smarty_tpl->tpl_vars['template_name']->value);?>
 <?php }
if (!empty($_smarty_tpl->tpl_vars['template_data']->value)) {?>Total Time <?php echo htmlspecialchars(sprintf("%.5f",$_smarty_tpl->tpl_vars['execution_time']->value), ENT_QUOTES, 'ISO-8859-1');
}?></h1>
...
?>
                <font color=brown><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['template']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</font>
                <br>&nbsp;&nbsp;<span class="exectime">
                (compile <?php echo htmlspecialchars(sprintf("%.5f",$_smarty_tpl->tpl_vars['template']->value['compile_time']), ENT_QUOTES, 'ISO-8859-1');?>
) (render <?php echo htmlspecialchars(sprintf("%.5f",$_smarty_tpl->tpl_vars['template']->value['render_time']), ENT_QUOTES, 'ISO-8859-1');?>
) (cache <?php echo htmlspecialchars(sprintf("%.5f",$_smarty_tpl->tpl_vars['template']->value['cache_time']), ENT_QUOTES, 'ISO-8859-1');?>
)
                 </span>
                <br>
            <?php
...
$__foreach_vars_1_total = $_smarty_tpl->smarty->ext->_foreach->count($_from);
if ($__foreach_vars_1_total) {
...
?>
            <tr class="<?php if ($_smarty_tpl->tpl_vars['vars']->iteration%2 == 0) {?>odd<?php } else { ?>even<?php }?>">
                <td><h3><font color=blue>$<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vars']->key, ENT_QUOTES, 'ISO-8859-1');?>
</font></h3>
...
$_smarty_tpl->tpl_vars['vars'] = new Smarty_Variable();
$__foreach_vars_2_total = $_smarty_tpl->smarty->ext->_foreach->count($_from);
if ($__foreach_vars_2_total) {
$_smarty_tpl->tpl_vars['vars']->iteration=0;
foreach ($_from as $_smarty_tpl->tpl_vars['vars']->key => $_smarty_tpl->tpl_vars['vars']->value) {
$_smarty_tpl->tpl_vars['vars']->iteration++;
...
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'id', 0);
    ...
    _smarty_console = window.open("", "console<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
", "width=1024,height=600,left=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['offset']->value, ENT_QUOTES, 'ISO-8859-1');?>
,top=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['offset']->value, ENT_QUOTES, 'ISO-8859-1');?>
